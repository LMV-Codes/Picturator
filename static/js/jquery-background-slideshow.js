...
$("body").backgroundSlideshow({ images: imgList, delay: 3000 })

$("body").backgroundSlideshow({ images: imgList, transitionDuration: 5000 })

$("body").backgroundSlideshow({ images: imgList, fixed: true })

$("body").backgroundSlideshow({
    images: imgList, onBeforeTransition: function (index) {
        console.log("before transition", index)
    }, onAfterTransition: function (index) { console.log("after transition", index) },
})
